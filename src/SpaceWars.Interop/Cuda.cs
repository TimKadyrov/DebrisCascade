...
/// <c>struct ObjElem</c> in spacewars_cuda.cu exactly (10 sequential doubles).
/// </summary>
...
{
    private const string Lib = "spacewars_cuda";
...
public static class Cuda
{
    ...
    private static void Probe()
    {
        ...
        catch (DllNotFoundException) { _device = "spacewars_cuda.dll not found"; _available = false; }
        catch (BadImageFormatException) { _device = "spacewars_cuda.dll architecture mismatch"; _available = false; }
